...
export default function IntroBlock() {
  ...
  const dockLinks = [
    ...
    { title: "Artstation", icon: <svg version="1.1" height="200px" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 208.8 195.9" className="scale-175"><style type="text/css"></style><g><path d="M51.4,123.3l8.9,15.4l0,0c1.8,3.5,5.4,5.9,9.5,5.9l0,0l0,0h59.3l-12.3-21.3H51.4z"/><path d="M157.2,123.4c0-2.1-0.6-4.1-1.7-5.8l-34.8-60.4c-1.8-3.4-5.3-5.7-9.4-5.7H92.9l53.7,93l8.5-14.7 C156.7,127,157.2,125.8,157.2,123.4z"/><polygon points="108.1,108.1 84.2,66.6 60.2,108.1"/></g></svg>, href: "https://choheron.artstation.com/" },
  ]
  ...
  return (
    <div className="relative mx-auto w-full max-w-[800px] h-fit">
      <div className="max-w-full">
        ...
        <p className="text-sm sm:text-base font-bold">Hello, my name is</p>
        <WaveReveal
          className={`${BRFont.className} text-[2rem] md:text-[4rem] mx-auto w-fit -my-3 text-black dark:text-white`}
          mode="word"
