...
export default function ProjectSwapTextCard({ initialText, finalText, projectObj }: FlipTextCardProps) {
  return (
    <div className={`relative group flex min-h-60 w-full flex-col justify-between rounded-3xl bg-background/10 border-2 border-black p-6 mt-5 md:max-w-[300px] hover:scale-105 transition duration-100 ${projectObj.base_className} overflow-hidden shadow-2xl`}>
      ...
      <div className="flex flex-col justify-between md:min-w-72">
        <div className="md:hidden">
          <div className="text-lg font-semibold">{initialText}</div>
